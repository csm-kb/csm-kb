...
- **Principal Software Engineer / VPE @ Venvee**
  ...
  - directed platform roadmaps, worked w/ CPO and leads to devise critical projects for the core product roadmap
  - kept cloud compute spend under 10k/mo and optimized data pipeline architecture to compress time-series data storage by 20x using Parquet
  - delivered breakthrough product by automating edge->cloud E2E testing and infra deployments, implementing observability using OpenTelemetry, and shipping ML/CV work
  - was the source-level domain expert of entire product, contributing solutions and serving as a vital business translator
  - made tactical debt tradeoffs to meet very tight deadlines that would make-or-break get the product off the ground
  - onboarded new enterprise customers and executed site hardware deployments
- **CTO @ Venvee** - https://venvee.com/
  ...
  - designed and tested AI/computer vision techniques for real-time multi-camera object detection and tracking
  - implemented a data security, privacy, and compliance pipeline (SOC 2, ISO 27001) with Drata + AWS
  - implemented CI/CD + GitOps practices with GitLab for serverless and container-based apps to ship faster
  - created novel tech for edge deployment & servicing (MLOps, IoT adm.) of heavy data models leveraging IoT cloud services
  - worked with key business partners, advisors, and stakeholders to unblock engineering teams in production
...
- **openlab Summer Student @ CERN** - https://home.cern/news/news/computing/cern-openlab-trains-next-generation-computing-experts
  ...
  - yes, the European Centre for Nuclear Research... no, there were no black holes or D-mails.
  - 1st place for best presentation to a panel of world-expert judges = me!
...
---
```
- I know my way around compiler + language design and computer architecture (including research into photonics), thanks to post-grad.
